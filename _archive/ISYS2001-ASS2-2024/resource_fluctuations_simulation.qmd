...
For this assignment you need to conduct a visual analysis and report your findings of:

1. Assess the impact of volatility on the stability of resource prices by experimenting with different volatility values.

2. Model a supply disruption event and analyse how it affects the price trend and the impact of the disruption's severity.

3. (Optional) Explore simple strategies a business might use to hedge against price fluctuations.
