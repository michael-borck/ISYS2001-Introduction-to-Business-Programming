...
For this assignment you need to conduct a visual analysis and report your findings of thje following tasks.  

1. Investigate how volatility affects stock price stability and the potential for investment gains or losses.

2. Simulate a major market event and analyse its immediate and long-term effects on stock prices.

3. (Optional) Develop simple trading strategies based on price trends and test their effectiveness over the simulation period.
